...
enum class MyEnum { Default, Value1, Value2 };
...
TEST_CASE("T getSafe(const json& j, const std::string& key, const T& default_value)",
          "[json_config]") {
    SECTION("int32_t") {
    ...
    SECTION("bool") {
        nlohmann::json json_data = {{"bool", true}, {"wrong_type", "value2"}, {"wrong_type2", 53}};
        ...
        bool wrong_type2_value = JsonConfig::getSafe(json_data, "wrong_type2", bool{});
        REQUIRE(wrong_type2_value == false);
    ...
    SECTION("float") {
        nlohmann::json json_data = {
            {"float", 3.14f}, {"wrong_type", "value2"}, {"wrong_type2", 12}};
...
TEST_CASE("T getSafe(const json& j, const std::string& key)", "[json_config]") {
    SECTION("int32_t") {
        nlohmann::json json_data = {{"int32_t", 42}, {"wrong_type", "value2"}};
        int32_t value = JsonConfig::getSafe<int32_t>(json_data, "int32_t");
        REQUIRE(value == 42);
        int32_t wrong_type_value = JsonConfig::getSafe<int32_t>(json_data, "wrong_type");
        REQUIRE(wrong_type_value == 0);
        int32_t missing_value = JsonConfig::getSafe<int32_t>(json_data, "missing_key");
        REQUIRE(missing_value == 0);
    }

    SECTION("bool") {
        nlohmann::json json_data = {{"bool", true}, {"wrong_type", "value2"}, {"wrong_type2", 53}};
        bool value = JsonConfig::getSafe<bool>(json_data, "bool");
        REQUIRE(value == true);
        bool wrong_type_value = JsonConfig::getSafe<bool>(json_data, "wrong_type");
        REQUIRE(wrong_type_value == false);
        bool wrong_type2_value = JsonConfig::getSafe<bool>(json_data, "wrong_type2");
        REQUIRE(wrong_type2_value == false);
        bool missing_value = JsonConfig::getSafe<bool>(json_data, "missing_key");
        REQUIRE(missing_value == false);
    }
    ...
    SECTION("float") {
        nlohmann::json json_data = {
            {"float", 3.14f}, {"wrong_type", "value2"}, {"wrong_type2", 12}};
        float value = JsonConfig::getSafe<float>(json_data, "float");
        REQUIRE(value == 3.14f);
        float wrong_type_value = JsonConfig::getSafe<float>(json_data, "wrong_type");
        REQUIRE(wrong_type_value == 0.0f);
        float wrong_type2_value = JsonConfig::getSafe<float>(json_data, "wrong_type2");
        REQUIRE(wrong_type2_value == 0.0f);
        float missing_value = JsonConfig::getSafe<float>(json_data, "missing_key");
        REQUIRE(missing_value == 0.0f);
    }

    SECTION("double") {
        nlohmann::json json_data = {{"double", 3.14}, {"wrong_type", "value2"}};
        double value = JsonConfig::getSafe<double>(json_data, "double");
        REQUIRE(value == 3.14);
        double wrong_type_value = JsonConfig::getSafe<double>(json_data, "wrong_type");
        REQUIRE(wrong_type_value == 0.0);
        double missing_value = JsonConfig::getSafe<double>(json_data, "missing_key");
        REQUIRE(missing_value == 0.0);
    }

    SECTION("string") {
        nlohmann::json json_data = {{"string", "value1"}, {"wrong_type", 42}};
        std::string value = JsonConfig::getSafe<std::string>(json_data, "string");
        REQUIRE(value == "value1");
        std::string wrong_type_value = JsonConfig::getSafe<std::string>(json_data, "wrong_type");
        REQUIRE(wrong_type_value == "");
        std::string missing_value = JsonConfig::getSafe<std::string>(json_data, "missing_key");
        REQUIRE(missing_value == "");
    }

    SECTION("enum") {
        nlohmann::json json_data = {{"enum", "value1"}, {"wrong_type", 42}};
        MyEnum value = JsonConfig::getSafe<MyEnum>(json_data, "enum");
        REQUIRE(value == MyEnum::Value1);
        MyEnum wrong_type_value = JsonConfig::getSafe<MyEnum>(json_data, "wrong_type");
        REQUIRE(wrong_type_value == MyEnum::Default);
        MyEnum missing_value = JsonConfig::getSafe<MyEnum>(json_data, "missing_key");
        REQUIRE(missing_value == MyEnum::Default);
    }

    SECTION("uint8_t") {
        nlohmann::json json_data = {{"uint8_t", 42}, {"wrong_type", -12}, {"wrong_type2", 300}};
        uint8_t value = JsonConfig::getSafe<uint8_t>(json_data, "uint8_t");
        REQUIRE(value == 42);
        uint8_t wrong_type_value = JsonConfig::getSafe<uint8_t>(json_data, "wrong_type");
        REQUIRE(wrong_type_value == 0);
        uint8_t wrong_type2_value = JsonConfig::getSafe<uint8_t>(json_data, "wrong_type2");
        REQUIRE(wrong_type2_value == 0);
        uint8_t missing_value = JsonConfig::getSafe<uint8_t>(json_data, "missing_key");
        REQUIRE(missing_value == 0);
    }

    SECTION("int8_t") {
        nlohmann::json json_data = {{"int8_t", -12}, {"wrong_type", 300}, {"wrong_type2", -400}};
        int8_t value = JsonConfig::getSafe<int8_t>(json_data, "int8_t", int8_t{});
        REQUIRE(value == -12);
        int8_t wrong_type_value = JsonConfig::getSafe<int8_t>(json_data, "wrong_type");
        REQUIRE(wrong_type_value == 0);
        int8_t wrong_type2_value = JsonConfig::getSafe<int8_t>(json_data, "wrong_type2");
        REQUIRE(wrong_type2_value == 0);
        int8_t missing_value = JsonConfig::getSafe<int8_t>(json_data, "missing_key");
        REQUIRE(missing_value == 0);
    }
}